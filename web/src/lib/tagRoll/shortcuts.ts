...
export const TAG_ROLL_SHORTCUTS: readonly TagRollShortcut[] = [
  ...
  { id: 'mode-lyrics', keys: 'Y', label: 'Toggle Lyrics lane', group: 'modes' },
  ...
  { id: 'hear-sketch', keys: 'J', label: 'Hear Chords-lane sketch chord (ignore stacks)', group: 'transport' },
  ...
  { id: 'copy', keys: 'Ctrl+C', label: 'Copy selected notes / section', group: 'edit' },
  { id: 'cut', keys: 'Ctrl+X', label: 'Cut selected notes / section', group: 'edit' },
  { id: 'paste', keys: 'Ctrl+V', label: 'Paste at playhead (cursor)', group: 'edit' },
  ...
  { id: 'multi-add', keys: 'Ctrl+Click', label: 'Toggle note in selection; empty places a note', group: 'edit' },
  {
    id: 'melody-pass',
    keys: 'Ctrl+Click ×2',
    label: 'Select 2 notes on different parts → Link melody pass (inspect bar)',
    group: 'edit',
  },
